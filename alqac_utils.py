...
def f2_metric(eval_sets, pipeline: Pipeline, retrival_method: str, retriever_top_k: int = 100, ranker_top_k: int = 1):
    """
...
def evaluate_pipeline(eval_sets, pipeline: Pipeline, retrival_method: str, retriever_top_k: int = 100, ranker_top_k: int = 1):
    """
    Evaluate the pipeline on the `eval_sets`. Evaluate how good the pipeline's retrieved documents cover ground-truth relevant articles.
